<?php
	...
	$data = $magic->lib->stats();
	$orders = $magic->connector->orders(array(), 'updated', 'DESC', 5, 0);
	$section = 'Dashbroad';
	$recent_res = $magic->lib->recent_resources();
	$magic->lib->display_check_system();
?>
<div class="magic_wrapper magic_dashbroad" id="magic-<?php echo $section; ?>-page">
	<?php $magic->do_action('dashboard-container'); ?>
	<div class="magic_container">
		<div class="magic-col magic-col-3">
			<div class="lusime_box_stats">
				<i class="fa fa-heart-o" style="background: #1e88e5"></i>
				<div class="box_right">
					<span><?php echo $data['cliparts'];?></span>
					<p><?php echo $magic->lang('Cliparts'); ?></p>
				</div>
			</div>
		</div>
		<div class="magic-col magic-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $magic->lang('Templates'); ?></p>
				</div>
			</div>
		</div>
		<div class="magic-col magic-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $magic->lang('Orders'); ?></p>
				</div>
			</div>
		</div>
		<div class="magic-col magic-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $magic->lang('Shapes'); ?></p>
				</div>
			</div>
		</div>
	</div>
	<div class="magic_container">
		<div class="magic-col magic-col-6">
			<div class="lusime_box_dashbroad">
				<h3><?php echo $magic->lang('Recent Orders'); ?></h3>
				<div class="box_content">
					<table class="magic_table">
						<thead>
							<tr>
								<th><?php echo $magic->lang('Orders ID'); ?></th>
								<th><?php echo $magic->lang('Total'); ?></th>
								<th><?php echo $magic->lang('Status'); ?></th>
								<th><?php echo $magic->lang('Date'); ?></th>
						...
						<tbody>
							...
							if(count($orders['rows']) > 0){
								...
								?>
								<tr>
									<td><a href="<?php echo $magic->cfg->admin_url;?>magic-page=order&order_id=<?php echo $item['id'];?>">#<?php echo $item['id'];?></a></td>
									<td><?php echo $magic->lib->price($item['total']);?></td>
									<td><em class="pen"><?php echo $magic->apply_filters('order_status', $item['status']);?></em></td>
									<td><?php echo date("F j, Y", strtotime($item['updated']));?></td>
									<td><a href="<?php echo $magic->cfg->admin_url;?>magic-page=order&order_id=<?php echo $item['id'];?>">View</a></td>
								</tr>
								<?php
								}
							}else{
								?>
								<tr>
									<td colspan="5"><?php echo $magic->lang('Apologies, but no results were found.');?></td>
								</tr>
								<?php
							}
							?>
		...
		<div class="magic-col magic-col-6">
			<div class="lusime_box_dashbroad magic_blog">
				<h3><?php echo $magic->lang('MagicRugs RSS'); ?></h3>
				<div class="box_content" id="magic-rss-display">
					<p><i><?php echo $magic->lang('Loading latest blog'); ?>..</i></p>
				</div>
			</div>
		</div>
	</div>
	<div class="magic_container">
		<div class="magic-col magic-col-6">
			<div class="lusime_box_dashbroad list_thumb">
				<h3><?php echo $magic->lang('Newest cliparts'); ?></h3>
				<div class="box_content">
					<?php
					...
					if($count > 0){
						...
						<li>
							<div class="thumb_preview">
								...
								<div class="thumb_overlay">
									...
									<p><?php echo $magic->lang('Category'); ?>: <?php echo implode(', ', $item['categories']);?></p>
								</div>
							</div>
						</li>
						<?php
						...
						?>
						<p><?php echo $magic->lang('Apologies, but no results were found.');?></p>
						<?php
					}
					?>
				</div>
		...
		<div class="magic-col magic-col-6">
			<div class="lusime_box_dashbroad list_thumb">
				<h3><?php echo $magic->lang('Newest design templates'); ?></h3>
				<div class="box_content">
					<ul>
					<?php
	...
	<div class="magic_support_icon">
		<div class="magic_support_close">
