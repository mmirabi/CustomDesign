<?php
	...
	$data = $customdesign->lib->stats();
	$orders = $customdesign->connector->orders(array(), 'updated', 'DESC', 5, 0);
	$section = 'Dashbroad';
	$recent_res = $customdesign->lib->recent_resources();
	$customdesign->lib->display_check_system();
?>
<div class="customdesign_wrapper customdesign_dashbroad" id="customdesign-<?php echo $section; ?>-page">
	<?php $customdesign->do_action('dashboard-container'); ?>
	<div class="customdesign_container">
		<div class="customdesign-col customdesign-col-3">
			<div class="lusime_box_stats">
				<i class="fa fa-heart-o" style="background: #1e88e5"></i>
				<div class="box_right">
					<span><?php echo $data['cliparts'];?></span>
					<p><?php echo $customdesign->lang('Cliparts'); ?></p>
				</div>
			</div>
		</div>
		<div class="customdesign-col customdesign-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $customdesign->lang('Templates'); ?></p>
				</div>
			</div>
		</div>
		<div class="customdesign-col customdesign-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $customdesign->lang('Orders'); ?></p>
				</div>
			</div>
		</div>
		<div class="customdesign-col customdesign-col-3">
			<div class="lusime_box_stats">
				...
				<div class="box_right">
					...
					<p><?php echo $customdesign->lang('Shapes'); ?></p>
				</div>
			</div>
		</div>
	</div>
	<div class="customdesign_container">
		<div class="customdesign-col customdesign-col-6">
			<div class="lusime_box_dashbroad">
				<h3><?php echo $customdesign->lang('Recent Orders'); ?></h3>
				<div class="box_content">
					<table class="customdesign_table">
						<thead>
							<tr>
								<th><?php echo $customdesign->lang('Orders ID'); ?></th>
								<th><?php echo $customdesign->lang('Total'); ?></th>
								<th><?php echo $customdesign->lang('Status'); ?></th>
								<th><?php echo $customdesign->lang('Date'); ?></th>
						...
						<tbody>
							...
							if(count($orders['rows']) > 0){
								...
								?>
								<tr>
									<td><a href="<?php echo $customdesign->cfg->admin_url;?>customdesign-page=order&order_id=<?php echo $item['id'];?>">#<?php echo $item['id'];?></a></td>
									<td><?php echo $customdesign->lib->price($item['total']);?></td>
									<td><em class="pen"><?php echo $customdesign->apply_filters('order_status', $item['status']);?></em></td>
									<td><?php echo date("F j, Y", strtotime($item['updated']));?></td>
									<td><a href="<?php echo $customdesign->cfg->admin_url;?>customdesign-page=order&order_id=<?php echo $item['id'];?>">View</a></td>
								</tr>
								<?php
								}
							}else{
								?>
								<tr>
									<td colspan="5"><?php echo $customdesign->lang('Apologies, but no results were found.');?></td>
								</tr>
								<?php
							}
							?>
		...
		<div class="customdesign-col customdesign-col-6">
			<div class="lusime_box_dashbroad customdesign_blog">
				<h3><?php echo $customdesign->lang('MagicRugs RSS'); ?></h3>
				<div class="box_content" id="customdesign-rss-display">
					<p><i><?php echo $customdesign->lang('Loading latest blog'); ?>..</i></p>
				</div>
			</div>
		</div>
	</div>
	<div class="customdesign_container">
		<div class="customdesign-col customdesign-col-6">
			<div class="lusime_box_dashbroad list_thumb">
				<h3><?php echo $customdesign->lang('Newest cliparts'); ?></h3>
				<div class="box_content">
					<?php
					...
					if($count > 0){
						...
						<li>
							<div class="thumb_preview">
								...
								<div class="thumb_overlay">
									...
									<p><?php echo $customdesign->lang('Category'); ?>: <?php echo implode(', ', $item['categories']);?></p>
								</div>
							</div>
						</li>
						<?php
						...
						?>
						<p><?php echo $customdesign->lang('Apologies, but no results were found.');?></p>
						<?php
					}
					?>
				</div>
		...
		<div class="customdesign-col customdesign-col-6">
			<div class="lusime_box_dashbroad list_thumb">
				<h3><?php echo $customdesign->lang('Newest design templates'); ?></h3>
				<div class="box_content">
					<ul>
					<?php
	...
	<div class="customdesign_support_icon">
		<div class="customdesign_support_close">
		...
		<div class="customdesign_support_open">
	...
	<ul class="customdesign_list_icon">
		<li><span>Send Message</span><a href="https://www.facebook.com/magicrugsstore" target="blank" class="fa fa-facebook"></a></li>
		<li><span>Custom Request</span><a href="https://www.magicrugs.com/contactus" target="blank" class="fa fa-pencil-square-o"></a></li>
		<li><span>Help Center</span><a href="https://mehdimirabi.com/" target="blank" class="fa fa-life-ring"></a></li>
	</ul>
</div>
